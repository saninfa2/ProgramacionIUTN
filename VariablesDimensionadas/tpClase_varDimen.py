...
#Tuve que copiar el archivo de funciones porque no me encontraba el paquete pero 
#eliminé las demás funciones para que no fuese un archivo tan pesao
#Por eso el nombre
...
#Mientras la condición sea distinta de falso o se ingrese la opcion de salir, se presenta el menu 
